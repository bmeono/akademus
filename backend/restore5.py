...
done = ['areas', 'asignaturas', 'auditoria_accesos', 'bloques_tematicos', 'codigos_otp', 'configuraciones', 'configuraciones_puntaje', 'cursos', 'especialidades', 'flashcard_historial', 'flashcards', 'grupos_academicos', 'grupos_especialidad', 'notificaciones', 'opciones', 'preguntas_puntaje_grupo', 'progreso_flashcards', 'respuestas_simulacro', 'resultados_detalle']

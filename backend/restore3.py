...
done = ['areas', 'asignaturas', 'auditoria_accesos', 'bloques_tematicos', 'codigos_otp', 'configuraciones', 'configuraciones_puntaje', 'cursos', 'especialidades', 'flashcard_historial', 'flashcards', 'grupos_academicos', 'grupos_especialidad', 'notificaciones', 'opciones']
...
for block in blocks:
    ...
    create_lines = [l for l in block.split("\n") if l.strip().startswith("INSERT") == False and l.strip() != ""]
